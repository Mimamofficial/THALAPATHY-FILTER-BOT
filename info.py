...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/MRN_Tutorial/1807")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '-1002275478487').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002528229701')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mzautofilterbot:mzautofilterbot@cluster0.fgtaywi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002445547306').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MRN_Movies_Search_Group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mimam_official_Hindi_Tv_Shows')
...
URL = "https://uncertain-elizabet-muzaffar-c1f706a5.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://uncertain-elizabet-muzaffar-c1f706a5.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://uncertain-elizabet-muzaffar-c1f706a5.koyeb.app/".format(FQDN)
else:
    URL = "https://uncertain-elizabet-muzaffar-c1f706a5.koyeb.app/".format(FQDN)
